...
LONG_DESCRIPTION    ="""
	...
	http://packages.python.org/scikits.bvp_solver/. If you have questions or suggestions
        ...
        """
MAINTAINER          = 'Thomas Antony'
MAINTAINER_EMAIL    = "jsalvatier@gmail.com"
URL                 = "http://packages.python.org/bvp_solver/"
LICENSE             = "BSD"
VERSION             = "1.1"
...
def configuration(parent_package='',top_path=None):
    ...
    config.add_extension('bvp_solverf',
                         sources=['bvp_solver/lib/lampak.f',
				  'bvp_solver/lib/BVP_LA.f',
				  'bvp_solver/lib/BVP_M.f90',
                  'bvp_solver/lib/BVP_INTERFACE.f90',
				  'bvp_solver/lib/bvp_interface.pyf'])

    config.add_data_files('bvp_solver/examples/*.*')
    config.add_data_files('bvp_solver/lib/BVP_SOLVER_License.txt')
    config.add_data_files('bvp_solver/lib/BVP_LA_LicenseInfo.txt')
    return config
